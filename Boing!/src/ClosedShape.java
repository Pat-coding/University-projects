...
public abstract class ClosedShape {
	 ...
	 */
	protected ClosedShape (int insertionTime, int x, int y, int vx, int vy, Color colour, boolean flashed,
		...
		this.flashColours = flashColours;
	...
	public Color getFlashColours() {
		return flashColours;
	}

	public void setFlashColours(Color flashColours) {
		this.flashColours = flashColours;
	}
	...
	public void changeColours() {
		if(colour == getPrimaryColour() && flashed) {
			colour = flashColours;
		} else {
